...
::: notes
We standardize the difference using the SE, then plot it on the null curve so students can see how far out it lands.
:::
...
::: notes
WebR runs in the browser—no installs. Everything for the activity is on GitHub, ready to use or adapt.
:::
